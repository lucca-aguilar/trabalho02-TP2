...
struct Teste8Fixture {
    Teste8Fixture() {
        setup_dirs();

        criar_arquivo(BACKUP_PARM, TEST_ARQUIVO + "\n");
        criar_arquivo(HD_ARQUIVO, "Conteúdo do arquivo do teste da Regra 8.");
        criar_arquivo(PENDRIVE_ARQUIVO, "Conteúdo do arquivo do teste 8.");
    }
...
struct Teste9Fixture {
    Teste9Fixture() {
        setup_dirs();

        criar_arquivo(BACKUP_PARM, TEST_ARQUIVO + "\n");
        criar_arquivo(HD_ARQUIVO, "Conteúdo do arquivo do teste da Regra 9.");
        usleep(1000000); 
        criar_arquivo(PENDRIVE_ARQUIVO, "Conteúdo do arquivo do teste da Regra 9.");
    }
...
TEST_CASE_METHOD(Teste7Fixture, "Teste 7: Restauração de arquivo existente no Pen Drive para o HD, com arquivo mais recente", "[erro]") {
    int fazer_backup = 0;
    int resultado = executar_espelhamento(fazer_backup);
...
TEST_CASE_METHOD(Teste8Fixture, "Teste 8: Restauração de arquivo existente no Pen Drive para o HD, sem necessidade de atualização", "[faz_nada]") {
    int fazer_backup = 0;
    int resultado = executar_espelhamento(fazer_backup);
...
TEST_CASE_METHOD(Teste9Fixture, "Teste 9: Restauração de arquivo existente no Pen Drive para o HD, com atualização", "[restauracao]") {
    int fazer_backup = 0;
    int resultado = executar_espelhamento(fazer_backup);
